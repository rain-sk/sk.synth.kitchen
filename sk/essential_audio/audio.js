...
var Essential_Audio = (() => {
  ...
  function B() {
    ...
    ia.forEach((vo, ib) => {
      vo.innerHTML =
        '<div><div class="off"><button type="button">play</button></div></div><div><div><!----></div></div><div><!----></div>';
      var ic;
      ...
      a.id = ic;
      a.button = vo.querySelector("button");
